(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["refrendo-refrendo-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RefrendoPageModule = /** @class */ (function () {
                function RefrendoPageModule() {
                }
                return RefrendoPageModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RefrendoPage = /** @class */ (function () {
                function RefrendoPage(router, formBuilder, refrendoService, loadingService, toastService, storage, platform) {
                    this.router = router;
                ...
                RefrendoPage.prototype.ngOnInit = function () {
                ...
                RefrendoPage.prototype.ionViewDidEnter = function () {
                    var _this = this;
                    //this.resetForm();
                    //inicializar consulta fake
                    this.inicializarConsultaRefrendoFake();
                    //Obtener consultas recientes
                    this.storage.get('consultasRefrendo').then(function (consultas) {
                        _this.consultasRefrendo = consultas || [];
                    });
                    this.backbuttonSubscription = this.platform.backButton.subscribe(function () {
                        _this.router.navigateByUrl('/app/tabs/inicio');
                    });
                };
                RefrendoPage.prototype.ionViewWillLeave = function () {
                    this.backbuttonSubscription.unsubscribe();
                };
                //#region Consulta refrendo fake
                RefrendoPage.prototype.inicializarConsultaRefrendoFake = function () {
                ...
                RefrendoPage.prototype.consultaRefrendoFake = function (placa, serie) {
                    ...
                    var _placa = placa || this.formularioConsultaRefrendo.value['placa'];
                    var _serie = serie || this.formularioConsultaRefrendo.value['serie'];
                    ...
                    var slicedArray = this.consultasRefrendo.slice(0, 5);
                ...
                RefrendoPage.prototype.ejecutarConsultaRecienteFake = function (consulta) {
                 ...
                 */
                RefrendoPage.prototype.consultarRefrendo = function (placa, serie) {
                    var _this = this;
                    this.enviado = true;
                    if (!((placa && placa !== "") || (serie && serie !== ""))) {
                        if (this.formularioConsultaRefrendo.invalid || !((this.formularioConsultaRefrendo.value['placa'] && this.formularioConsultaRefrendo.value['placa'] !== "") || (this.formularioConsultaRefrendo.value['serie'] && this.formularioConsultaRefrendo.value['serie'] !== ""))) {
                    ...
                    var _placa = placa || this.formularioConsultaRefrendo.value['placa'];
                    var _serie = serie || this.formularioConsultaRefrendo.value['serie'];
                    this.refrendoService.obtenerRefrendoVehicular(_placa, _serie).subscribe(function (response) {
                        if (response) {
                            _this.refrendo = response;
                            _this.loadingService.dismiss();
                            //#region Almacenar consulta como reciente
                            var now = new Date(Date.now());
                            _this.consultasRefrendo.unshift({
                                date: now,
                                data: _this.refrendo.presupuesto
                            });
                            var slicedArray = _this.consultasRefrendo.slice(0, 5);
                            _this.storage.set('consultasRefrendo', slicedArray);
                            //#endregion 
                            var navigationExtras = {
                                state: {
                                    refrendo: _this.refrendo.presupuesto
                                }
                            };
                            _this.router.navigateByUrl('/app/tabs/refrendo/detalle-refrendo', navigationExtras);
                        }
                        else {
                            _this.toastService.present("No se encontro un vehículo con la placa o serie");
                            _this.loadingService.dismiss();
                        }
                    }, function (err) {
                 ...
                 */
                RefrendoPage.prototype.removerConsultasRefrendoRecientes = function () {
                    var _this = this;
                    this.storage.remove('consultasRefrendo').then(function (resolve) {
                        _this.consultasRefrendo = [];
                 ...
                 * @param consulta
                 */
                RefrendoPage.prototype.ejecutarConsultaReciente = function (consulta) {
                    if (consulta.data.vehiculo.placaActual === "" && consulta.data.vehiculo.serie === "") {
                        console.log("No se encontraron los datos necesarios para ejecutar la consulta");
                        this.toastService.present("No se encontraron los datos necesarios para ejecutar la consulta");
                        return;
                ...
                RefrendoPage.prototype.resetForm = function () {
                    this.formularioConsultaRefrendo.reset();
                    this.enviado = false;
                };
                RefrendoPage.prototype.cancelarConsultarRefrendo = function () {
                    this.router.navigateByUrl('/app/tabs/inicio', { replaceUrl: true });
                };
                return RefrendoPage;
            }());
            RefrendoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=refrendo-refrendo-module-es5.js.map
//# sourceMappingURL=refrendo-refrendo-module-es5.js.map