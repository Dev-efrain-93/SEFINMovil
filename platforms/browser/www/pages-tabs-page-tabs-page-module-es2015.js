...
let AcercaPage = class AcercaPage {
    constructor(popoverCtrl, storage, router, appVersion, platform) {
        this.popoverCtrl = popoverCtrl;
...
let InicioPage = class InicioPage {
    constructor(alertCtrl, loadingCtrl, modalCtrl, router, toastCtrl, config, platform) {
...
let PredialPage = class PredialPage {
    constructor(router, formBuilder, predialService, loadingService, toastService, storage, platform) {
        this.router = router;
