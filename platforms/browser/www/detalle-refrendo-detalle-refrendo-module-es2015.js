...
let DetalleRefrendoPopoverPage = class DetalleRefrendoPopoverPage {
...
DetalleRefrendoPopoverPage.ctorParameters = () => [
...
let DetalleRefrendoPageModule = class DetalleRefrendoPageModule {
};
...
let DetalleRefrendoPage = class DetalleRefrendoPage {
    constructor(router, route, config, storage, refrendoService, popoverController) {
        this.router = router;
        this.route = route;
        this.config = config;
...
DetalleRefrendoPage.ctorParameters = () => [
